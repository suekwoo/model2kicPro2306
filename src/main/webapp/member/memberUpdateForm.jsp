...
<body>
	...
	<form class="w3-container" name="f" action="memberUpdatePro.jsp" method="post">
		<table class="w3-table-all">
			...
			<tr>
				<td rowspan="4" valign="bottom" width="100px"><img src=""
					width="100" height="120" id="pic"><br> <font size="1">
						<a class="w3-button w3-green">사진등록</a>
				</font></td>
				<td>아이디</td>
				<td><%=m.getId() %></td>
			</tr>
			...
			<tr>
				<td>성별</td>
				<td><input type="radio" name="gender" value="1"  <%=m.getGender()==1 ? "checked" : "" %>>
					남 <input type="radio" name="gender" value="2"   <%=m.getGender()==2 ? "checked" : "" %>>여</td>
			</tr>
			<tr>
				<td>전화번호</td>
